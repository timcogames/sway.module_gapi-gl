...
public:
  static core::binding::TFunction<void(s32_t, u32_t *)> glGenFramebuffersEXT;
  static core::binding::TFunction<void(s32_t, const u32_t *)> glDeleteFramebuffersEXT;
  ...
  static core::binding::TFunction<void(u32_t, u32_t, u32_t, u32_t, s32_t)> glFramebufferTexture2DEXT;
  ...
  static core::binding::TFunction<void(u32_t, u32_t, u32_t, s32_t *)> glGetFramebufferAttachmentParameterivEXT;
