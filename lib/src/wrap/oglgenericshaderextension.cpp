...
core::binding::TFunction<void(u32_t, s32_t, lpcstr_t *, const s32_t *)> OGLGenericShaderExtension::glShaderSourceARB =
    nullptr;
core::binding::TFunction<void(u32_t)> OGLGenericShaderExtension::glCompileShaderARB = nullptr;
core::binding::TFunction<s32_t(u32_t, lpcstr_t)> OGLGenericShaderExtension::glGetAttribLocationARB = nullptr;
