#ifndef SWAY_GAPI_GL_SHADERPROGRAMHELPER_HPP
#define SWAY_GAPI_GL_SHADERPROGRAMHELPER_HPP
...
public:
  ...
  DECLARE_GENERIC_MEMBER(ShaderProgramHelper, DeleteProgram, void, s32_t, const u32_t *)
  ...
  DECLARE_GENERIC_MEMBER(ShaderProgramHelper, AttachShader, void, u32_t, u32_t)
  ...
  DECLARE_GENERIC_MEMBER(ShaderProgramHelper, DetachShader, void, u32_t, u32_t)
  ...
  DECLARE_GENERIC_MEMBER(ShaderProgramHelper, Uniform4f, void, s32_t, f32_t, f32_t, f32_t, f32_t)
  ...
  DECLARE_GENERIC_MEMBER(ShaderProgramHelper, UniformMatrix4f, void, s32_t, s32_t, bool, const f32_t *)
  ...
  DECLARE_GENERIC_MEMBER(ShaderProgramHelper, GetObjectParam, void, u32_t, u32_t, s32_t *)
...
#endif  // SWAY_GAPI_GL_SHADERPROGRAMHELPER_HPP
