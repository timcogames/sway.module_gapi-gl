...
public:
  ...
  DECLARE_GENERIC_MEMBER(OGLGenericBufferHelper, DeleteBuffers, void, u32_t, u32_t *)
  ...
  DECLARE_GENERIC_MEMBER(OGLGenericBufferHelper, BindBuffer, void, u32_t, u32_t)
  ...
  DECLARE_GENERIC_MEMBER(OGLGenericBufferHelper, BufferData, void, u32_t, ptrdiff_t, const void *, u32_t)
  ...
  DECLARE_GENERIC_MEMBER(OGLGenericBufferHelper, BufferSubData, void, u32_t, ptrdiff_t, ptrdiff_t, const void *)
