#ifndef SWAY_GAPI_GL_SHADERHELPER_HPP
#define SWAY_GAPI_GL_SHADERHELPER_HPP
...
class ShaderHelper {
public:
  ShaderHelper(std::function<core::binding::ProcAddress_t(ExtensionInitList_t)> exts);

  DECLARE_GENERIC_MEMBER(ShaderHelper, CreateShader, u32_t, u32_t)
  auto EMU_CreateShader(u32_t type) -> u32_t;
  auto STD_CreateShader(u32_t type) -> u32_t;
  auto ARB_CreateShader(u32_t type) -> u32_t;

  DECLARE_GENERIC_MEMBER(ShaderHelper, DeleteShader, void, std::optional<u32_t>)
  ...
  DECLARE_GENERIC_MEMBER(ShaderHelper, ShaderSource, void, std::optional<u32_t>, s32_t, lpcstr_t *, const s32_t *)
  ...
  DECLARE_GENERIC_MEMBER(ShaderHelper, CompileShader, void, std::optional<u32_t>)
  ...
  DECLARE_GENERIC_MEMBER(ShaderHelper, GetShaderParam, void, std::optional<u32_t>, u32_t, s32_t *)
...
#endif  // SWAY_GAPI_GL_SHADERHELPER_HPP
