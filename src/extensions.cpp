...
core::binding::TFunction<void (u32_t shaderObj, s32_t count, lpcstr_t * string, const s32_t * length)> Extension::glShaderSource = nullptr;
...
core::binding::TFunction<void (u32_t obj, s32_t maxLength, s32_t * length, lpstr_t infoLog)> Extension::glGetInfoLog = nullptr;
...
core::binding::TFunction<void (u32_t target, ptrdiff_t size, const void * data, u32_t usage)> Extension::glBufferData = nullptr;
core::binding::TFunction<void (u32_t target, ptrdiff_t offset, ptrdiff_t size, const void * data)> Extension::glBufferSubData = nullptr;
...
core::binding::TFunction<void (u32_t index, s32_t size, u32_t type, u8_t normalized, s32_t stride, const void * pointer)> Extension::glVertexAttribPointer = nullptr;
